...
common_dep(){
    if uname -a | grep riscv64 && cat /etc/os-release | grep -i "openEuler 23.09"; then
        curl -sO https://repo.tarsier-infra.com/openEuler-RISC-V/obs/hwobs_2309/noarch/python3-paramiko-3.2.0-1.oe2309.noarch.rpm
        curl -sO https://repo.tarsier-infra.com/openEuler-RISC-V/obs/hwobs_2309/riscv64/python3-bcrypt-3.2.2-1.oe2309.riscv64.rpm
        curl -sO https://repo.tarsier-infra.com/openEuler-RISC-V/obs/hwobs_2309/riscv64/python3-pynacl-1.5.0-1.oe2309.riscv64.rpm
        curl -sO https://repo.tarsier-infra.com/openEuler-RISC-V/obs/hwobs_2309/noarch/python3-pyasn1-0.4.8-4.oe2309.noarch.rpm
        curl -sO https://repo.tarsier-infra.com/openEuler-RISC-V/obs/hwobs_2309/riscv64/libsodium-1.0.18-1.oe2309.riscv64.rpm
